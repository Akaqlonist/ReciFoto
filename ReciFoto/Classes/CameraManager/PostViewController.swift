...
class PostViewController: UIViewController, VideoTrimmerDelegate {
    ...
    var camNavigationController = NavigationController()                    ///
                                                                            ///
    //CameraManageViewController                                                  ///
    lazy var cameraVC: CameraManageViewController = {                             ///
        let cameraVC = CameraManageViewController()                               ///
