//
//  CameraManageViewController.swift
//  Twitter_Post
//
...
extension CameraManageViewController: PhotoEditorDelegate {
...
protocol CameraManageViewControllerDelegate {
    
    func sendAssetIdToPostViewController(_ assetIdentifier: String?)
}


extension CameraManageViewController: CaptureButtonDelegate {
...
open class CameraManageViewController: UIViewController,VideoPreviewLayerProvider, NavigationControllerDelegate {
    
    
    var delegate: CameraManageViewControllerDelegate?
